...
int		main(void)
{
	...
	printf("**** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** \n");
	usleep(500);
	a = ft_printf("abd %**.*-d abd %**.*-d$", 1, 10, 0, 12345, 14, 8, 0, 12345);
	printf("\n");
	printf("my42 return : %i\n", a);
	usleep(500);
	a = printf("abd %**.*-d abd %**.*-d$", 1, 10, 0, 12345, 14, 8, 0, 12345);
	printf("\n");
	...
	printf("nati return : %i\n", a);
	usleep(500);
	a = ft_printf("abd %0**.*-d abd %0**.*-d$", 1, 10, 0, 12345, 14, 8, 0, 12345);
	printf("\n");
	printf("my42 return : %i\n", a);
	usleep(500);
	a = printf("abd %0**.*-d abd %0**.*-d$", 1, 10, 0, 12345, 14, 8, 0, 12345);
	printf("\n");
	printf("nati return : %i\n", a);
	usleep(500);
	a = ft_printf("abd %0**.*-d abd %0**.*-d$", 1, 10, 0, -12345, 14, 8, 0, -12345);
