...
int		main(void)
{
	...
	usleep(500);
	printf("**** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** \n");
	printf("**** **** **** **** **** **** **** **** **** get-rotherrazy **** **** **** **** **** **** **** **** **** \n");
	printf("**** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** \n");
	a = ft_printf("abrother %**.*-rother abrother %**.*-rother$", 1, 10, 0, 14, 8, 0);
	printf("\n");
	printf("my42 return : %i\n", a);
	usleep(500);
	a = printf("abrother %**.*-rother abrother %**.*-rother$", 1, 10, 0, 14, 8, 0);
	printf("\n");
	...
	printf("nati return : %i\n", a);
	usleep(500);
	a = ft_printf("abrother %0**.*-rother abrother %0**.*-rother$", 1, 10, 0, 14, 8, 0);
	printf("\n");
	printf("my42 return : %i\n", a);
	usleep(500);
	a = printf("abrother %0**.*-rother abrother %0**.*-rother$", 1, 10, 0, 14, 8, 0);
	printf("\n");
	printf("nati return : %i\n", a);
	usleep(500);
	a = ft_printf("abrother %0**.*-rother abrother %0**.*-rother$", 1, 10, 0, 14, 8, 0);
