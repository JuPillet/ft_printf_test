...
int		main(void)
{
	...
	printf("**** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** **** \n");
	usleep(500);
	a = ft_printf("abc %**.*-p abc %**.*-p$", 1, 10, 0, b, 14, 8, 0, b);
	printf("\n");
	usleep(500);
	a = printf("abc %**.*-p abc %**.*-p$", 1, 10, 0, b, 14, 8, 0, b);
	printf("\n");
	printf("my42 return : %i\n", a);
	printf("nati return : %i\n", a);
	usleep(500);
	a = ft_printf("abc %0**.*-p abc %0**.*-p$", 1, 10, 0, b, 14, 8, 0, b);
	printf("\n");
	usleep(500);
	a = printf("abc %0**.*-p abc %0**.*-p$", 1, 10, 0, b, 14, 8, 0, b);
	printf("\n");
	printf("my42 return : %i\n", a);
	printf("nati return : %i\n", a);
	usleep(500);
